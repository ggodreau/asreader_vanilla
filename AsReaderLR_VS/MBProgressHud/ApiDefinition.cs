...
namespace MBProgressHud
{
    ...
    interface MBProgressHUD
    {
        ...
        //void ShowAnimated (bool animated, dispatch_block_t block, MBProgressHUDCompletionBlock completion);
        ...
        //void ShowAnimated (bool animated, dispatch_block_t block, DispatchQueue queue, MBProgressHUDCompletionBlock completion);
        ...
        UIView Indicator { get; set; }

        // @property (assign) BOOL only;
        [Export("only")]
        bool Only { get; set; }
